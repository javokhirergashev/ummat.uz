...
/* @var $searchModel app\models\TestimonialsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = "Mijozlarning izohlari";
                ...
                <div class="page-header">
                    ...
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><span>Mijozlarning izohlari</span></li>
                        </ol>
                    </nav>
...
<div class="testimonials-index">
    ...
    <p>
        <?= Html::a("Yangi izoh qo'shish", ['create'], ['class' => 'btn btn-success']) ?>
    </p>
...
//            'id',
            ...
            [
                'attribute' => 'images',
                'value' => function($data){
                    $image = StaticFunctions::getImage('testimonials',$data->id, $data->images);
