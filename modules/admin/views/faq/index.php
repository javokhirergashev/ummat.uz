...
$this->title = "Ko'p beriladigan savollar";
                ...
                <div class="page-header">
                    ...
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class=""><a href="<?=\yii\helpers\Url::to(['/admin/menu'])?>">Savollar/</a></li>
                            <li class="breadcrumb-item active" aria-current="page"><span>Savolni  o'zgartirish</span></li>
                        </ol>
                    </nav>
...
<div class="faq-index">
    ...
    <p>
        <?= Html::a('Yangi savol yaratish', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
